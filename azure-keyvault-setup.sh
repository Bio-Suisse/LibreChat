...
# Azure Key Vault Setup für LibreChat
...
# Aktuellen Benutzer als Key Vault Administrator hinzufügen (RBAC)
...
# Warten auf Berechtigungspropagation
echo "⏳ Warten auf Berechtigungspropagation (30 Sekunden)..."
sleep 30
